...
const SignupScreen = () => {
    ...
    return (
        ...
        <View className="bg-white h-full w-full">
            ...
            <View className="h-full w-full flex justify-around pt-56  pb-10">

                <View className="flex items-center">
                    <Animated.Text entering={FadeInUp.duration(1000).springify()} className="text-white font-bold tracking-wider text-4xl mt-9">Sign Up</Animated.Text>
                </View>
